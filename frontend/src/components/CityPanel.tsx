...
import { getAirQualityColor, getFaceIconSvg } from "../utils/AirQualityColor.ts";
...
export default function CityPanel({onClose , station , measurements, weather, pm25Predictions, isPredictLoading}: CityPanelProps) {
    ...
    const airQualityColor = getAirQualityColor(latestMeasurement?.pm25);
    const airQualityFace = getFaceIconSvg(latestMeasurement?.pm25);
    ...
    return (
        <>
            ...
            <div style={{
                ...
                width: isSmallScreen ? "100dvw" : "380px",
                height: isSmallScreen ? "100dvh" : "auto",
                zIndex: 3000,
                boxSizing: "border-box",
                background: "rgba(255, 255, 255, 0.98)",
                backdropFilter: "blur(10px)",
                padding: isSmallScreen ? "20px" : "12px 14px",
                borderRadius: isSmallScreen ? 0 : "12px",
                border: isSmallScreen ? "none" : "1px solid rgba(255, 255, 255, 0.2)",
                ...
                gap: "6px",
                overflowY: "auto",
                maxHeight: isSmallScreen ? "none" : "calc(100vh - 130px)",
            ...
            >
                ...
                <span style={{ fontSize: "17px", fontWeight: "600", color: "#17C1DF", display: "flex", alignItems: "center", gap: "7px", wordBreak: "break-word" }}>
                    ...
                    {isSmallScreen && (
                        <button
                            onClick={onClose}
                            style={{
                                background: "rgba(23, 193, 223, 0.1)",
                                border: "none",
                                borderRadius: "50%",
                                width: "32px",
                                height: "32px",
                ...
                <div style={{ marginTop: "2px", width: "100%"}}>
                    {latestMeasurement ? (
                        <div style={{
                            ...
                            alignItems: "center",
                            border: `1px solid ${airQualityColor}40`,
                        }}>
                ...
                <div style={{ margin: "0", width: "100%", display: "flex", flexDirection: "column", gap: "8px" }}>
                    {weather ? (
                        <div style={{
                            width: "100%",
